...
label start:
    ...
    e "จัดผมก็ได้ใช้เวลาไปสักพักแล้ว วันนี้จะเดินทางยังไงดีนะ"
    menu:
        'รถเมล์':
            jump bus
        'วินมอไซค์':
            jump motorcycle_taxi
    #กระต่ายแยกออกมา
    label bus:
        ...
        if score == 0:
            ...
            menu:
            'Toxic Level Up':
                jump toxic_go_to_school_1
        label toxic_go_to_school_1:
    ...
    label motorcycle_taxi:
        ...
        menu:
            'Toxic Level up':
            jump toxic_go_to_school_2
        label toxic_go_to_school_2:
