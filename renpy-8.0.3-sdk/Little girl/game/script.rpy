...
label start:
    ...
    menu:
        "มัดรวบ":
            ...
            menu:
                "หนังยางมัดผมธรรมดา"
                    r "มันช่างไม่มีสีสันเอาซะเลย มัดธรรมดาเนี่ยนะ มุมมองแฟชั่นของเธอนี่ใช้ไม่ได้เลย"
                    r "โธ่ มันไม่วิบๆวับๆเลย ไม่ฟรุ้งฟริ้งเลยอ่ะ"
                    r "อีกอย่างนะ เธอคิดดูสิ หนังยางธรรมดาแบบนี้มันจะทำลายสุขภาพผมเธอ ถ้ามัดไปนานๆผมมัดก็จะหักงอ"
                    r "และก็ถ้ามัดไปผมของเธอจะเป็นรอยและไม่สวย ไม่งาม ผมเสียได้นะเธอ"
                    r "ถ้าเธอมัดแน่นๆ เธอก็จะปวดหัว และยิ่งถ้าเธอปวดหัวมากๆเธอก็จะเรียนไม่รู้เรื่อง ถ้าเธอเรียนไม่รู้เรื่องเธอก็จะสอบตก ถ้าเธอสอบตกเธอแย่แน่ๆ"
                ...
                "ที่รัดผมน่ารัก"
                    r "ฉันรู้นะว่าที่รัดผมนี้มันเข้ากับเธอมาก"
                    r "แต่เธอก็รู้ดีนี่ว่าที่มัดผมแบบนี้มันไม่เคยพอดีกับการมัดของเธอเลย"
                    r "ถ้าเธอมัดสองทบมันก็จะไม่แน่นแล้วมันก็จะหลุดสุดบ่อย สุดท้ายเธอก็ต้องมัดใหม่ทั้งวันอยู่ดี"
                    ...
                    j "อะ อ่า.. โอเคค่ะ ลอนผมก็ลอนผม"
                "หนังยางรัดแกง"
                    r "โอ้มายก้อด เธอต้องบ้าไปแล้วแน่ๆ หนังยางรัดแกงเนี่ยนะ!"
