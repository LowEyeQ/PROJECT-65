    ...
    if score >= 1:
        menu:
            'Toxic Level Up':
                ...
                r 'อนาคตเธอคงมืดบอด ไร้จุดหมายและมีปลายทางที่เตียงนอนกับหมอนเน่า ฟังดูดีหรอ ไม่เลย เธอจะกลายเป็นตัวไร้ประโยชน์ในบ้าน'
                r 'อยู่ในห้องตลอดไป!!!!'
...
label finish4:
    ...
    #The End
    $ renpy.movie_cutscene('images/End.avi')
    return
